...
export default function Settings() {
  const { inventory, refresh } = useContext(InventoryContext);
  ...
  async function handleTestNotification() {
    if (permission !== 'granted') {
      addToast('Activa los permisos de notificaciones primero.', 'error');
      return;
    }
  ...
  async function handleRefresh() {
    try {
      await refresh();
      addToast('Inventario recargado.', 'success');
    } catch {
      addToast('Error al recargar el inventario.', 'error');
    }
  }
