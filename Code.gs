  ...
  try {
    ...
    const payload = {
      ...
      generationConfig: {
        temperature: 0.1,
        maxOutputTokens: 512,
        // gemini-2.5-flash es un modelo "thinking": los tokens de razonamiento
        // se descuentan de maxOutputTokens. Sin esto, el razonamiento consume
        // todo el presupuesto y el JSON de salida se trunca a la mitad.
        thinkingConfig: { thinkingBudget: 0 },
        // Fuerza salida JSON válida (sin markdown ni texto alrededor).
